...
class ProjectManager:
    ...
    def save_file_to_project(
        ...
        """
        Raw uploads are saved on local disk of the machine that received them.
        File extraction happens during the same request.
        """
    ...
    def save_extracted_text(cls, project_id: str, text: str) -> None:
        """
        Extracted text lives in Supabase so /build on any machine can read it.
        """
